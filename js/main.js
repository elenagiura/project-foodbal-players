...
var teamData = {
	...
	players: [
		new Player("David","De Gea", 1, "Goalkeeper", 30, "./images/david-de-dea.png"),
		new Player("Victor","Lindelof", 2, "Defender", 26, "./images/victor-lindelof.png"),
		new Player("Paul","Pogba", 6, "Midfielder", 27, "./images/paul-pogba.png"),
		new Player("Edinson","Cavani", 7, "Forward", 34, "./images/edinson-cavani.png"),
		new Player("Eric","Bailly", 3, "Defender", 26, "./images/eric-bailly.png"),
		new Player("Diogo","Dalot", 20, "Defender", 21, "./images/diogo-dalot.png"),
		new Player("Facundo","Pellistri", 28, "Midfielder", 19, "./images/facundo-pellistri.png"),
		new Player("Jesse","Lingard", 14, "Midfielder", 28, "./images/jesse-lingard.png"),
		new Player("Teden","Mengi", 43, "Defender", 18, "./images/teden-mengi.png"),
		new Player("Anthony","Martil", 9, "Forward", 25, "./images/anthony-martial.png"),
		new Player("Mason","Greenwood", 11, "Forward", 19, "./images/mason-greenwood.png"),
		new Player("Luke","Shaw", 23, "Defender", 25, "./images/luke-shaw.png"),
		new Player("Alex", "Telles", 27, "Defender", 28, "./images/alex-telles.png"),
		new Player("Daniel", "James", 21, "Midfielder", 23, "./images/daniel-james.png"),
		new Player("Nemanja","Matic", 31, "Midfielder", 32, "./images/nemanja-matic.png")
	]
}
...
function squadsDom (arr) {
	...
	for (var i=0; i<arr.length; i++) {
		...
		player.innerHTML="<img src='"+arr[i].imgPath+"'/>"
		+"<span>"+arr[i].number+"</span>"
		+"<div><p>Full name: <span>"+arr[i].name+" "+arr[i].lastName+"</span></p>"
		+"<p>Position: <span>"+arr[i].position+"</span></p>"
		+"<p>Age: <span>"+arr[i].age+"</span></p></div>";
...
function chooseSubs () {
	...
	var playerForChange = document.querySelectorAll('main section article')[number];
...
function makeSubs (number, playerForChange, subs) {
	...
	document.querySelector('main section:nth-child(3)').appendChild(playerForChange);
	document.querySelector('main aside div p').textContent = subs.querySelector('span').textContent+" "+subs.querySelector('p span').textContent;
	document.querySelector('main aside div p:last-child').textContent = playerForChange.querySelector('span').textContent+" "+playerForChange.querySelector('p span').textContent;
}

function timer () {
	var timer = parseInt(document.querySelector('header section div p').textContent);
...
document.querySelector('main aside>button:last-child').addEventListener('click', function(){
	document.querySelector('header section div div').classList.remove('anim');
